                    ...
                    <section aria-labelledby="author-profile-heading" style={{ border: "1px solid #1f2330", padding: "1.5rem", borderRadius: "2.5rem", background: "#0b0d12", marginBottom: "2rem" }}>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <a href="https://www.linkedin.com/in/anandayuda/" target="_blank" rel="noopener noreferrer" aria-label="Josh Smith on LinkedIn" style={{
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                    width: "40px",
                                ...
                                <a href="https://www.facebook.com/CourseSpeakOfficial/" target="_blank" rel="noopener noreferrer" aria-label="CourseSpeak on Facebook" style={{
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                    width: "40px",
                                ...
                                <a href="https://x.com/courses_peak" target="_blank" rel="noopener noreferrer" aria-label="CourseSpeak on X" style={{
                                    display: "flex",
                                    alignItems: "center",
                                    justifyContent: "center",
                                    width: "40px",
