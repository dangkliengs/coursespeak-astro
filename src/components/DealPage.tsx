            ...
            <div className="container deal-layout" style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem 1rem", display: "grid", gridTemplateColumns: "1fr 340px", gap: "3rem" }}>
                ...
                <main>
                    ...
                    <section aria-labelledby="about-heading" style={{ marginBottom: "2rem" }}>
                        ...
                        <p style={{ fontSize: "0.9rem", color: "#94a3b8", marginBottom: "1.25rem" }}>
                            The following is the full official course description as published on <strong>{deal.provider || "Udemy"}</strong> by instructor <strong style={{ color: "#FBBF24" }}>{deal.instructor}</strong>. It covers the curriculum structure, teaching methodology, and topic scope for this <a href={`/categories/${slugifyCategory(deal.category || "")}`} style={{ color: "inherit", textDecoration: "underline" }}><strong>{deal.category}</strong></a> course:
                        </p>
                        <div
                            ref={markdownRef}
                    ...
                    <section aria-labelledby="deal-summary-heading" style={{ borderTop: "1px solid #1f2330", paddingTop: "2rem", marginBottom: "2rem" }}>
                        <h2 id="deal-summary-heading" style={{ fontSize: "1.4rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            <span style={{ width: "6px", height: "32px", background: "#fbbf24", borderRadius: "9999px" }} aria-hidden="true" />
                            Is the {deal.title} Coupon Worth It?
                        </h2>

                        <div style={{ background: "#0b0d12", border: "1px solid #1e293b", borderRadius: "16px", overflow: "hidden" }}>
                            {/* Meta bar */}
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "0.5rem", padding: "0.75rem 1.25rem", background: "#111827", borderBottom: "1px solid #1e293b", fontSize: "0.8rem", color: "#94a3b8" }}>
                            ...
                            <div style={{ padding: "1.5rem" }}>
                                {/* Analysis */}
                                <p style={{ fontSize: "0.9rem", color: "#cbd5e1", lineHeight: 1.7, margin: "0 0 1.25rem 0" }}>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem", marginBottom: "1.25rem" }}>
                                    <div style={{ background: "rgba(34, 197, 94, 0.04)", border: "1px solid rgba(34, 197, 94, 0.15)", borderRadius: "10px", padding: "1rem" }}>
                                        <h3 style={{ fontSize: "0.9rem", fontWeight: 700, color: "#22c55e", margin: "0 0 0.6rem 0", display: "flex", alignItems: "center", gap: "0.4rem" }}>
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                                            Pros
                                        </h3>
                                        <ul style={{ margin: 0, padding: 0, listStyle: "none", color: "#cbd5e1", fontSize: "0.82rem", lineHeight: 1.65 }}>
                                    ...
                                    <div style={{ background: "rgba(239, 68, 68, 0.04)", border: "1px solid rgba(239, 68, 68, 0.15)", borderRadius: "10px", padding: "1rem" }}>
                                        <h3 style={{ fontSize: "0.9rem", fontWeight: 700, color: "#ef4444", margin: "0 0 0.6rem 0", display: "flex", alignItems: "center", gap: "0.4rem" }}>
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="3"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                                            Cons
                                        </h3>
                                        <ul style={{ margin: 0, padding: 0, listStyle: "none", color: "#cbd5e1", fontSize: "0.82rem", lineHeight: 1.65 }}>
                                            <li style={{ padding: "3px 0", display: "flex", gap: "6px" }}>
                                ...
                                <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "1.25rem" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", flex: 1, minWidth: "200px", padding: "0.75rem 1rem", background: "rgba(251, 191, 36, 0.04)", border: "1px solid rgba(251, 191, 36, 0.12)", borderRadius: "10px" }}>
                                        <div style={{ width: "40px", height: "40px", borderRadius: "50%", background: "linear-gradient(135deg, #FBBF24, #F59E0B)", display: "flex", alignItems: "center", justifyContent: "center", color: "#1f2330", fontWeight: 700, fontSize: "0.9rem", flexShrink: 0 }}>JS</div>
                                        <div>
                                            <div style={{ fontWeight: 600, color: "#fff", fontSize: "0.85rem" }}>Josh Smith</div>
                                            <div style={{ color: "#94a3b8", fontSize: "0.75rem" }}>Lead Course Reviewer</div>
                                        </div>
                                        <a href="/about" style={{ marginLeft: "auto", fontSize: "0.75rem", color: "#60a5fa", textDecoration: "underline", whiteSpace: "nowrap" }}>Credentials →</a>
                                    </div>
                                    <div style={{ flex: 2, minWidth: "250px", padding: "0.75rem 1rem", background: "linear-gradient(135deg, rgba(251, 191, 36, 0.06) 0%, rgba(251, 191, 36, 0.02) 100%)", border: "1px solid rgba(251, 191, 36, 0.12)", borderRadius: "10px" }}>
                                        <p style={{ fontSize: "0.82rem", color: "#cbd5e1", lineHeight: 1.6, fontStyle: "italic", margin: 0 }}>
                                            "Given the{discountPct > 0 ? ` ${discountPct}%` : ""} price reduction{deal.rating ? ` and verified ${deal.rating.toFixed(1)}-star rating` : ""}, <strong style={{ color: "#fff" }}>{deal.title}</strong> is a strong value in {deal.category || "professional development"} on {deal.provider || "Udemy"}. Enrollment recommended while the coupon is active."
                                        </p>
                                    </div>
                                </div>

                                {/* Verdict + Redeem link */}
                                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", padding: "0.75rem 1.25rem", background: "linear-gradient(135deg, #073618, #0d4d2a)", borderRadius: "10px", border: "1px solid rgba(34, 197, 94, 0.2)" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                        <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: "1rem" }}>✓</div>
                                        <div>
                                            <div style={{ fontSize: "1rem", fontWeight: 700, color: "#fff" }}>Final Verdict: Worth It</div>
                                ...
                                {/* Additional Info */}
                                <div style={{ marginTop: "1rem", padding: "0.75rem 1rem", background: "rgba(251, 191, 36, 0.05)", border: "1px solid rgba(251, 191, 36, 0.12)", borderRadius: "8px", fontSize: "0.82rem", color: "#cbd5e1", lineHeight: 1.6 }}>
                                    <strong style={{ color: "#FBBF24" }}>New to redeeming coupons?</strong>{" "}
                                    Visit our <a href="/how-to-redeem-coupon" style={{ color: "#60a5fa", textDecoration: "underline" }}>step-by-step guide</a> for detailed instructions on how to apply coupon codes.
                                    <span style={{ display: "block", marginTop: "4px", color: "#64748b", fontSize: "0.78rem" }}>
                    ...
                    {deal.instructor && (
                        <section aria-labelledby="instructor-heading" style={{ borderTop: "1px solid #1f2330", paddingTop: "2rem", marginBottom: "2rem" }}>
                            <h2 id="instructor-heading" style={{ fontSize: "1.4rem", fontWeight: 700, color: "#fff", marginBottom: "1.25rem", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                                <span style={{ width: "6px", height: "32px", background: "#3b82f6", borderRadius: "9999px" }} aria-hidden="true" />
                                Instructor Profile
                            </h2>
                            <p style={{ fontSize: "0.9rem", color: "#94a3b8", marginBottom: "1.25rem" }}>
                                Background information on <strong style={{ color: "#fff" }}>{deal.instructor}</strong>, the instructor responsible for this course on <strong>{deal.provider || "Udemy"}</strong>.
                            </p>
                            <div style={{ background: "#0b0d12", border: "1px solid #1e293b", borderRadius: "16px", overflow: "hidden" }}>
                                <div style={{ padding: "1.5rem 1.5rem 1rem", display: "flex", gap: "1rem", flexWrap: "wrap", alignItems: "center" }}>
                                    <div style={{ width: "52px", height: "52px", borderRadius: "50%", background: "linear-gradient(135deg, #3b82f6, #8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                                    ...
                                    <a
                                        ...
                                        style={{
                                            display: "inline-flex", alignItems: "center", gap: "0.35rem",
                                            padding: "0.45rem 1rem", background: "rgba(59, 130, 246, 0.1)",
                                            border: "1px solid rgba(59, 130, 246, 0.25)", borderRadius: "8px",
                                            fontSize: "0.8rem", color: "#60a5fa", textDecoration: "none", fontWeight: 600,
                                        }}
                                    >
                                        Full Profile ↗
                                    </a>
                                </div>
                                <div style={{ borderTop: "1px solid #1e293b", padding: "1rem 1.5rem", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.75rem", fontSize: "0.85rem" }}>
                                    <div>
                                        <span style={{ color: "#64748b", fontWeight: 500 }}>Subject Area</span>
                                        <div style={{ color: "#cbd5e1", marginTop: "2px" }}>{deal.category || "Development"}</div>
                                    </div>
                                    {deal.students && (
                                        <div>
                                            <span style={{ color: "#64748b", fontWeight: 500 }}>Total Students</span>
                                            <div style={{ color: "#cbd5e1", marginTop: "2px" }}>{deal.students.toLocaleString()}+ enrolled</div>
                                        </div>
                                    )}
                                    {deal.rating && (
                                        <div>
                                            <span style={{ color: "#64748b", fontWeight: 500 }}>Rating</span>
                                            <div style={{ color: "#cbd5e1", marginTop: "2px" }}>{deal.rating.toFixed(1)} / 5.0</div>
                                        </div>
                                    )}
                                    {deal.duration && (
                                        <div>
                                            <span style={{ color: "#64748b", fontWeight: 500 }}>Course Duration</span>
                                            <div style={{ color: "#cbd5e1", marginTop: "2px" }}>{deal.duration}</div>
                                        </div>
                                    )}
                                    <div style={{ gridColumn: "1 / -1" }}>
                                        <span style={{ color: "#64748b", fontWeight: 500 }}>Teaching Approach</span>
                                        <div style={{ color: "#cbd5e1", marginTop: "2px", lineHeight: 1.5 }}>
                    ...
                    <section aria-labelledby="author-profile-heading" style={{ border: "1px solid #1e293b", padding: "1.5rem", borderRadius: "16px", background: "#0b0d12", marginBottom: "2rem" }}>
                        ...
                        <div style={{ display: "flex", gap: "1.25rem", flexWrap: "wrap", alignItems: "flex-start" }}>
                            <div style={{ width: "72px", height: "72px", borderRadius: "50%", background: "linear-gradient(135deg, #1e293b, #334155)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden", border: "2px solid #FBBF24" }}>
                                <img src="/images/author.jpg" alt="Josh Smith" style={{ width: "100%", height: "100%", objectFit: "cover" }} loading="lazy" />
                            </div>
                            <div style={{ flex: 1, minWidth: "240px" }}>
                                <div style={{ fontSize: "1.1rem", fontWeight: 700, color: "#fff", marginBottom: "2px" }}>Josh Smith</div>
                                <div style={{ fontSize: "0.8rem", color: "#FBBF24", fontWeight: 600, marginBottom: "0.5rem" }}>Udemy Coupon Specialist</div>
                                <p style={{ fontSize: "0.85rem", color: "#94a3b8", lineHeight: 1.65, margin: "0 0 0.75rem 0" }}>
                                ...
                                <div style={{ display: "flex", gap: "0.75rem" }}>
                                    <a href="https://www.linkedin.com/in/anandayuda/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ width: "32px", height: "32px", borderRadius: "6px", background: "#1e293b", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", transition: "background 0.2s" }}
                                       onMouseEnter={(e) => (e.currentTarget as HTMLElement).style.background = "#0077b5"}
                                    ...
                                    <a href="https://www.facebook.com/CourseSpeakOfficial/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ width: "32px", height: "32px", borderRadius: "6px", background: "#1e293b", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", transition: "background 0.2s" }}
                                    ...
                                    <a href="https://x.com/courses_peak" target="_blank" rel="noopener noreferrer" aria-label="X" style={{ width: "32px", height: "32px", borderRadius: "6px", background: "#1e293b", display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", transition: "background 0.2s" }}
                                       onMouseEnter={(e) => (e.currentTarget as HTMLElement).style.background = "#333"}
                                       onMouseLeave={(e) => (e.currentTarget as HTMLElement).style.background = "#1e293b"}>
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="#94a3b8"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                    </a>
                                    <a href="/blog" style={{ display: "inline-flex", alignItems: "center", gap: "4px", padding: "0 0.75rem", borderRadius: "6px", background: "rgba(251, 191, 36, 0.1)", border: "1px solid rgba(251, 191, 36, 0.2)", color: "#FBBF24", textDecoration: "none", fontSize: "0.75rem", fontWeight: 600, transition: "background 0.2s" }}
