...
- Astro 7.3 static generation — 2,000+ pages built in under 60 seconds
...
| Layer | Technology |
|---|---|
| Framework | [Astro 7.3](https://astro.build/), static site generation |
...
[CourseSpeak](https://coursespeak.com) includes a production-ready admin panel built into the Astro 7.3 static architecture — a rare capability for a fully static site.
